...
/*   Updated: 2021/04/30 17:42:34 by mlorette         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(Form &obj, std::string &target) : name(obj.name), grade(obj.grade), exec(obj.exec), target(target)
{
	status = obj.status;
}
